...
const ContentArea = ({ data }: any) => (
  <Card style={{ padding: 50 }}>
    ...
    >
      Games {data.site.siteMetadata.title}
    </h1>
    {
      // tslint:disable:react-no-dangerous-html
      <div dangerouslySetInnerHTML={{ __html: data.site.siteMetadata.games }} />
      // tslint:enable:react-no-dangerous-html
    }
    <ul>
      <li><Link to={`/games/times-table-speed`} style={{ textDecoration: "none" }}> Speed Tables</Link></li>
    </ul>
  </Card>
)
